	...
	<main class="main">
		...
		<div class="content">
			...
			<form action="<?= base_url() ?>/Admin/SejarahAdd/addArtikel" method="POST" enctype="multipart/form-data">
				...
				<input type="text" name="judul" placeholder="Judul artikel" required title="Wajib tulis judul artikel" />

				<label for="title">Description</label>
				<input type="text" name="deskripsi" placeholder="deskripsi singkat artikel" required title="Wajib tulis deskripsi artikel" />

				<label for="content">Konten</label>
				<textarea name="konten" cols="30" rows="10" placeholder="Tuliskan isi pikiranmu..."></textarea>
